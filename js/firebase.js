...
function fetchProducts() { 
  db.collection("products").get().then(function(querySnapshot) {
    ...
    querySnapshot.forEach(function(doc) {
      ...
      productList += '<li class="item-thumbs span3 design" data-id="id-0" data-type="web"><a class="hover-wrap" data-fancybox-group="gallery" title="'+ doc.data().name +'"><span class="overlay-img" id="demo"></span><span class="overlay-img-thumb font-icon-plus"></span></a><img id="'+imgId+'" alt="'+ doc.data().description +'"></li>';
  ...
  //document.getElementById("demo").onclick=function() {storeInSession()};
  function storeInSession(){
    console.log("storeInSession called");
    var item= doc.id;
